...
const params = {
  Code: {
    S3Bucket: "test-stack-mybucket160f8132-dsubclchfz3n", // BUCKET_NAME
    S3Key: "index.js.zip", // ZIP_FILE_NAME
  },
  FunctionName: "LAMBDA_TEST_20230919",
  Handler: "index.handler",
  Role: "arn:aws:iam::175551741108:role/test-stack-myLambdaRole8B777879-M1J7VJKT3H61", // IAM_ROLE_ARN; e.g., arn:aws:iam::650138640062:role/v3-lambda-tutorial-lambda-role
  Runtime: "nodejs18.x",
  Description:
